...
public class GestorEquipos {
	...
	public boolean AgregarEquipo() {
		...
		for (int i = 0; i < 11; i++) {
			...
			String posicion = (String) JOptionPane.showInputDialog(null, "Ingrese nombre de Posicion: ", "Posicion",
	...
	public boolean EliminarEquipo() {
		...
		String seleccionEquipoEliminar = (String) JOptionPane.showInputDialog(null, "Seleccione una opción:", "Menú",
				JOptionPane.QUESTION_MESSAGE, null, nombresEquiposEliminar, nombresEquiposEliminar[0]);
	...
	public Partido JugarPartido(Equipo equipo1, Equipo equipo2) {
		if (equipo1 == equipo2) {
			...
			if (equipo1.getJugadores().size() < 7 || equipo2.getJugadores().size() < 7) {
				...
				if (goles1 == goles2) {
					...
					for (int i = 0; i < 6; i++) {
						...
						if (golesPenales2 == 1) {
							...
							JOptionPane.showMessageDialog(null, "Erro el penal  " + equipo2.getNombreClub());
						}
					}
				...
				return new Partido(equipo1, equipo2, goles1, goles2, penales1, penales2);
			}
		}
	}
